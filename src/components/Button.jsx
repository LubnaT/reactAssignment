...
function Button() {
  ...
  return (
    <div>
        <div className='w-[360px] h-[500px] rounded-3xl bg-blue-200 mt-[10px] mx-auto'>
            {/* ------- */}
            <div>
            ...
            {/* ----- */}
    <button onClick={data} className="w-[250px] h-[40px] mt-[10px] mx-[50px] bg-yellow-300 border-2 border-slate-900 rounded-full">Follow Me</button>
   </div>
   </div>
  )
}
